...
const checkConnection = require('./lab-08/middleware/check-connection');
...
// NOT FOUND
const api404 = require('./lab-08/middleware/api-404');
app.use('/api', api404); // use express default for non-api routes

// ERRORS
const errorHandler = require('./lab-08/middleware/error-handler');
